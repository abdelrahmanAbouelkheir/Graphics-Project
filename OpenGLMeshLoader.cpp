...
void LoadAssets()
{
	...
	model_medicine1.Load("Models/medicine/medicines/Box.3ds");
	model_medicine2.Load("Models/medicine/medicines/Bottle.3ds");

	model_spaceCraftBunker.Load("Models/rocket/Soyuz.3ds");
